  ...
  return (
    <div className="min-h-full w-full p-6 flex flex-col gap-4">
      <header className="flex items-center justify-between">
        <h1 className="text-xl font-semibold">Screenshot Hotkey</h1>
        <div className="text-sm text-slate-400">Press <kbd className="px-1 py-0.5 rounded bg-slate-800 border border-slate-700">Cmd</kbd>/<kbd className="px-1 py-0.5 rounded bg-slate-800 border border-slate-700">Ctrl</kbd> + <kbd className="px-1 py-0.5 rounded bg-slate-800 border border-slate-700">4</kbd></div>
      </header>
      ...
      <div className="flex-1 overflow-auto rounded border border-slate-800 bg-slate-950 p-2">
        {img ? (
          ...
          <div className="h-full w-full grid place-items-center text-slate-500">
            No screenshot yet. Press Cmd/Ctrl + 4 or click "Capture now".
          </div>
        )}
      </div>
    </div>
